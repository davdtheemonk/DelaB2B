...
const DetailScreens = ({navigation,route})=>{
    ...
    const [dealsBtn,selectDealsBtn] = useState(false)
...
<MapView initialRegion={{}} mapType="mutedStandard" style={{flex:1}}
 ></MapView>
            ...
            <View style={{paddingVertical:24,paddingHorizontal:32,marginBottom:30,backgroundColor:"#eee"}}>
            <Text  style={{fontSize:20,fontWeight:'bold',fontWeight:"bold",color:COLORS.grey,marginTop:5}}>House Rules</Text>
...
<HotelDeals data={item.deals} show={dealsBtn}   onDismiss={()=>{
      selectDealsBtn(false);}
      }
      enableBackDropDismiss/>
            ...
            <TouchableOpacity activeOpacity={0.7} onPress={()=>{
                ...
                <Text style={{color:COLORS.white,fontWeight:"bold",fontSize:20}}>View deals</Text>
            </TouchableOpacity>
